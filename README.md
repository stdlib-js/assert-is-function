...
```javascript
isFunction = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-function@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-function@v0.1.1-umd/browser.js"></script>
```
